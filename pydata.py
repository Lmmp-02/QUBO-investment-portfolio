...
# Descargar precios de los últimos 3 meses
...
budget = 4  # número máximo de activos a seleccionar
risk_factor = 0.5  # λ: tradeoff entre retorno y riesgo
...
# Resolver con GroverOptimizer
algorithm_globals.random_seed = 42
sampler = Sampler()  # Aer Sampler (backend cuántico simulado)
...
print("\n✅ Activos seleccionados en la cartera óptima:")
